...
读者可阅读笔者的入门[系列文章][1]获取更详细的信息，或直接使用 [WebAV][8] 开源项目在浏览器中创建/编辑音视频文件。
...
我们都知道**视频是由一系列图片组成**的，图片上的像素点即是原始数据；

![img-frames](./img-frames.png)
...
图像帧压缩后分为 I/P/B 三种类型，I 帧起始加上其后的 P/B 帧构成一个 GOP（Group of Pictures）。
![GoP](./gop.png)
...
![chunk-to-frame](./chunk-to-frame.png)
...
复杂图像处理，如绿幕抠图、特效、自定义滤镜等，需配合 WebGL Shader 实现。
