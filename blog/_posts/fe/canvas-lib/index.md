...
[DEMO](https://bilibili.github.io/WebAV/demo/4_2-recorder-avcanvas)  
...
画布中的元素（也可称为 Sprite），每个元素的的位置信息由 IRect 描述，可点击[DEMO](https://bilibili.github.io/WebAV/demo/4_2-recorder-avcanvas)进行体验。
