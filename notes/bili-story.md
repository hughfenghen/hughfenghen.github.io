...
有天他微信说：你看看股票涨了好多，快点接 offer，如果股票涨到 35 刀，估计 HR 要跟你重新谈薪酬方案哦。

2020 年 5 月，我信了 B 站的未来 —— Z 世代，我信了股票增涨定能弥补遗憾。  
于是，我接了 offer，入职 B 站直播中心部门，职级 3-1 资深前端。  
...
_注：B 站技术人均大佬，具体分为：高级大佬、资深大佬、专家大佬，女装大佬_

## 二

直播部门内部讲究**业务闭环**，就是按业务垂直划分组织架构，区别于按岗位横向划分。  
...
技术分享没做几期，我就被一个音视频大佬“借”去重构 Web 播放器。  
为什么借我？因为其他人不想干。

这个是真大佬，业界知名，百科能搜到的那种，你也可称之为巨佬。  
_按 B 站习惯，我仍称大佬_

大佬很风趣、很大方、对工作很有激情，平时不玩 LoL，工作需要也能非常投入地关注赛事直播。  
...
至此，我在 B 站就跟这个播放器项目给绑定了，我跟它一起入了轮回。

## 四

为什么说“我跟播放器一起入了**轮回**”？  
因为了解 B 站的小伙伴都知道，B 站喜欢调组织架构，后来历经不知多少次调整，我都会跟它一起。

接了重构播放器的任务后，我被安排到主站播放器组，先去把直播的 Web 播放器交接过来。
...
开始，我感觉自己有点像“间谍”，交接的项目中有一个比较核心的 NPM 依赖，我却没有代码访问权限，无代码重构谁碰到都头疼。

我非常直男地在会议上问交接方，为啥不能给我开代码权限？
对方：“...”。

但这些困难自然难不倒 3-1 的资深大佬，我不小心发现该依赖的 NPM 包中居然提交了 SourceMap 文件，于是利用 SourceMap 反解出源码，继续快乐地重构。

作为一个开发，每天都写新代码，当然是快乐的。  
快乐地忙碌半年后，项目终于顺利上线，没出什么幺蛾子。  
也拿到还行的结果 —— 唯一的四星绩效，成功晋升 3-2 资深大佬+，是当时直播前端的巅峰之一。

大概两年后，某个新业务也需要直播播放器的代码，进行定制开发。  
领导说：打个 NPM 包给他，不要给代码。

喂，这个画面怎么有点似曾相识啊？  
于是，我不小心地把 SourceMap 文件打进 NPM 包，期望有心人能看见。
...
播放器重构上线后，我开始着手解决念念不忘的团队工程效率问题。

你敢信？ 2021 年，B 站规模一万多人，还在使用 SwitchHost 切换测试环境这种小作坊方案，这是我一入职就无法忍受的事情。

经过一年迭代与推广，新方案落地，小有成效，在基层口碑也不错。  
取名 FF，因为键盘上这两个按键非常方便输入，引申含义 Fast-Forward。  
解决的诸多技术挑战此处自不必多言，其中部分技术实现，写了文章和专利：[Web 终极拦截技巧（全是骚操作）][6]、Web 自集成式代理方案（预告）

**后来有两件小事让我印象比较深刻**

一是，方案在直播基本普及，当我打算推广到其它大部门，所以寻求直属领导的支持时，领导说做成这样就够了，没必要推到其它部门。  
我猜大概原因是，直属领导是音视频方向，这个工程优化跟他的 OKR 目标不匹配，所以对他来说是没有价值的。

二是，一次偶然聊天，业务组领导问我“FF（方案落地的产品名字）是什么“。  
这让我有点震惊，当时 FF 的 PV 已经有 5000+，他下面的很多一线组员早就是 FF 的用户了，并且我在大周会上也汇报过两三次（相对别的项目来说，次数还是太少了）。

自然的，一年努力，叫好不叫座，即使后来 FF 的 PV 达到 1 万+，也是默默无闻、寂寥无声。

我想起，刚入职不久，就听说了在 B 站前端开发无人权。很多前端开发也都认为在 B 站，前端不能创造后端那么多价值，我反问“为什么不能”。
...
又换了组织、换了领导，组织架构已经调**麻**了，而“危险”却在悄悄靠近。

在新的组我主动申请加入了创新项目，因为这个创新项目跟我业余开源的项目 [WebAV][2] 有关，WebAV 是基于 WebCodecs 构建的，我相信 [WebCodecs][4] 会像 [MSE][5] 一样，影响 Web 音视频这个领域。

但没料到，我又做了一次错误选择，至少短期来说是错误的。  
新项目失败了，我拿了一个低绩效，虽然前端能力已达预期。  
我即使佛系不求高绩效，但也不能接受低绩效，毕竟影响年终奖。

我不服，申诉理由是

1. 项目失败不是前端造成的，我已经按预期完成了功能开发
2. 已有的能力可以复用到其它项目，未来还能创造价值
3. 这是新技术探索，发了文章、即将参加行业的技术分享，扩大了公司影响力

但申诉无果，还在会议室被三个领导加 HR 口头“群殴”。  
后续公司虽有多个项目复用了该项目的成果，但我的低绩效早已实锤。

欣慰的是，在公司业务立项之前，WebAV 是我的个人项目已经开源，后来我花了大量业余时间编写[系列文章][3]，帮助前端开发者入门音视频领域，相当于给社区贡献了一点价值。

绩效申诉会议上，直属领导问：“你说你写的这个有价值，那么谁来回应（承认）它的**价值**？”  
我想现在公司与社区都算有所回应了。
...
回首总结，这样经历并非意外。  
B 站是我见过人情味（人情世故）最浓的技术公司，且架构调整太过于频繁，而我一心写代码，没有一点政治敏感性，多次做了“错误”选择，还被饭搭子戏称为“消息绝缘体”。

_注：WebCodecs、MSE 是 Web 平台在音视频领域的规范_
_注：Flv.js 基于 MSE，WebAV 基于 WebCodecs_
...
没想到几年后竟看到了一些自己的影子：同样低学历，同样自驱做音视频创新业务，同样拿了低绩效，同感不公正而申诉，然后申诉失败。
...
_注：谦谦是 Flv.js 开源项目的作者，2016 年因低工资、低绩效而离职，成为技术圈一时热点_
